...
export const makeKB = (
  emotions: number[],
  {
    post_url, is_cutted, map_url, topic_url, album_url
  }: {
    post_url?: string, is_cutted?: boolean, map_url?: string, topic_url?: string, album_url?: string
  } = {},
) => ([
  ...
  [
    ...
    ...((album_url && !map_url) ? [{ text: 'Фотографии️', url: album_url }] : []),
